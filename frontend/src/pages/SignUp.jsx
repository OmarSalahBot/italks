...
const SignUp = () => {
    ...
    return (
            <div className="relative w-full max-w-md">
                ...
                <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-xl border border-slate-100 p-8">
                    <div className="mb-8 text-center">
                        <h2 className="text-2xl font-bold text-slate-800 mb-2">Create Account</h2>
                        <p className="text-slate-500 text-sm">Sign up for new account</p>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <UserRound className={`absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors duration-200 ${
                                    focusedField === 'username' ? 'text-violet-600' : 'text-slate-400'
                                }`} />
                                <input
                                    type="text"
